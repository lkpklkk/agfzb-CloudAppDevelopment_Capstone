...
async function dbCloudantConnect() {
  try {
    const cloudant = Cloudant({
      plugins: {
        iamauth: { iamApiKey: '0eHmeOhWnWLwT1C0WFNvzysQT3mF6_qmVgDJH-YbP7gM' },
      }, // Replace with your IAM API key
      url: 'https://d7815cc8-15e7-4e6e-81af-a84e55f0cc99-bluemix.cloudantnosqldb.appdomain.cloud', // Replace with your Cloudant URL
    });
